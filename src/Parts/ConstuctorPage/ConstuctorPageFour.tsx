...
const WIDGETS: Widget[] = [
    ...
    { key: 'grr', title: 'grr', desc: 'grr', route: '/main/grr', color: '#103b5e', icon: <IconBarChart /> },
    { key: 'grrd', title: 'grr-detail', desc: 'grr-detail', route: '/main/grr-detail', color: '#103b5e', icon: <IconBarChart /> },
];
...
const ConstuctorPageFour: React.FC = () => {
...
export default ConstuctorPageFour;
