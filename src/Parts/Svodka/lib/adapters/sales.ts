...
import { monthLabel, monthTick, unitUz } from "../format";
 ...
 */
/**
 * Диққат: булар API'дан келадиган `category` **қийматлари** — таржима
 * қилинмайди. Экранга чиқадиган номи `SALES_LABELS` дан олинади.
 */
...
export const SALES_LABELS: Record<string, string> = {
  "Реализация готовой продукции": "Tayyor mahsulot realizatsiyasi",
  "Остатки готовой продукции": "Tayyor mahsulot qoldig'i",
  "Остатки основного сырья и материалов": "Asosiy xomashyo va materiallar qoldig'i",
};

export const SALES_MIXED_UNITS_NOTE =
  "qiymat aralash o'lchov birliklarida (tn va dona), kategoriyalar o'zaro taqqoslanmaydi";
