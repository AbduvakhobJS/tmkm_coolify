...
/* Global rang palitrasini `:root` ga yozadi — CSS fayllardagi `var(--gc-*)`
   qiymatlari shu yerdan keladi. Render'dan oldin bajarilishi shart. */
applyPalette();
    ...
    <QueryClientProvider client={queryClient}>
      <BrowserRouter>
        <Routes>
          ...
          <Route path="/main/7" element={<PrivateRoute><NavbarOverlay><EnterExit /></NavbarOverlay></PrivateRoute>} />
          ...
          <Route path="/main/9" element={<PrivateRoute><NavbarOverlay><ResourceDashboard /></NavbarOverlay></PrivateRoute>} />
          <Route path="/main/logistics" element={<PrivateRoute><NavbarOverlay><Logistics /></NavbarOverlay></PrivateRoute>} />
